...
export default function ThesisPage() {
  ...
  const handleGenerate = async () => { setLoading(true); try { await apiClient.post(`/projects/${projectId}/thesis/generate`); message.success(t('common.success')); fetchData(); } catch (e: any) { message.error(e.response?.data?.detail || t('common.error')); setLoading(false); } };
